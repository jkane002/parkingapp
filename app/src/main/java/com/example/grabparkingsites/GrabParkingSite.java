package com.example.grabparkingsites;
...
public class GrabParkingSite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grab_parking_site);
...
//        });
    ...
    public void openTAPS() {
        Intent intent = new Intent(this, TAPS_Page.class);
